...
IdealIguana
    ...
    this is __after__ keenkitten! whoops
    ...
    Configuration 1:
        ...
        {'f0type': 2, 'filters': 0, 'kernel_size': 7, 'kernel_size_1': 4}
    ...
    Configuration 2:
        ...
        {'f0type': 0, 'filters': 5, 'kernel_size': 3, 'kernel_size_1': 0}
...
def model(x_train, y_train, x_test, y_test):
    ...
    kernel_size = {{choice([1,2,3,4,5,6,7,8])}}
    filters = {{choice([1,2,4,8,16,32])}}

    c0 = Conv1D(filters, kernel_size)(ci)
